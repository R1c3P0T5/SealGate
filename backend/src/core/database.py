...
async def seed_roles_and_permissions() -> None:
    ...
    _ALL_PERMISSIONS: list[tuple[str, str]] = [
        ("face:create", "Create face data for other users"),
        ("face:read", "View face data for other users"),
        ("face:delete", "Delete face data for other users"),
        ("user:read", "View other users' profiles"),
        ("user:update", "Update other users' profiles"),
        ("user:create", "Create new user accounts"),
        ("user:delete", "Delete other users' accounts"),
        ("user:manage", "Manage user roles and permissions"),
        ("door:create", "Create door records"),
        ("door:read", "View door details"),
        ("door:update", "Update door settings"),
        ("door:delete", "Delete door records"),
        ("door:unlock", "Trigger physical door unlock"),
        ("jutsu:read", "Read jutsu information"),
        ("jutsu:create", "Create jutsu"),
        ("jutsu:update", "Update jutsu"),
        ("jutsu:delete", "Delete jutsu"),
        ("camera:preview", "View live camera feeds"),
        ("log:read", "View access logs"),
        ("device:manage", "Configure camera devices"),
    ]
